                            ...
                            <!-- <div class="container">
                                ...
                                <div class="avatar-upload">
                                    ...
                                    <div class="avatar-preview">
                                        <div id="imagePreview" style="background-image: url({{asset('assets/images/dashboard/avatar.png')}});">
                                        </div>
                                    </div>
                                </div>
                            </div> -->
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <ul class="nav nav-pills">
                            <li><a href="{{route('user_receiveList')}}"><i class="fa fa-envelope"></i> 受信</a></li>
                            <li><a href="{{route('user_sentList')}}"><i class="fa fa-paper-plane"></i> 送信</a></li>
                            <li><a href="{{route('user_footprint')}}"><i class="fa fa-paw"></i> 足跡</a></li>
                            <li>
                                <a href="{{route('user_review')}}">
                                    <!-- <span class="badge badge-success pull-right">1</span> -->
                                    <i class="fa fa-paperclip"></i> 訪問
                                </a>
                            </li>
                            <li><a href="{{route('user_setting')}}"><i class="fa fa-cogs"></i> 設定</a></li>
                            <li><a href="{{route('user_plan')}}">無料プラン</a></li>
                        </ul>
                    </div>
                </div>
            </div>
